...
{
    public class TestBatchActionsWithValueTaskReturn
    {
        /// <summary>
        ...
        private async ValueTask<IEnumerable<int>> BatchAction(IEnumerable<int> items, CancellationToken token)
        {
        ...
        {
            static async ValueTask<IEnumerable<int>> Act(IEnumerable<int> items, CancellationToken token)
            {
